...
/**
 * Low-level write behaviour for the dataset writer: the {@code .dbf} character encoding, an
 * optional {@code .prj} WKT string and the policy for values that do not fit into a DBF field.
 *
 ...
 */
public record ShapefileWriteOptions(
    Charset dbfCharset, Optional<String> prjWkt, OverflowPolicy overflow) {
  ...
  public static ShapefileWriteOptions defaults() {
    return new ShapefileWriteOptions(
        StandardCharsets.UTF_8, Optional.empty(), OverflowPolicy.STRICT);
  }
